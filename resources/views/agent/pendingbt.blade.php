...
@section('pageCss')
@section('title','Pending Balance Transfer')
@endsection


@section('page-header','Pending Balance Transfer')
...
@section('content')
    ...
    <section class="container">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body" id="pendingbt_table_container">
                    <div class="kt-datatable" id="pendingbt_table"></div>
                </div>
            </div>
        </div>
      </div>
...
@section('pageJs')
    ...
    <script type="text/javascript">
        "use strict";
        var pendingbt_table;
        pendingbt_table = $("#pendingbt_table").KTDatatable({
            data: {
                type: "remote",
                source: {
                    read: {
                        url: "{{route('agent.pendingbt')}}",
                        method: 'GET',
                        map: function(t) {
                            var e = t;
        ...
        pendingbt_table.on('spinnerCallback',function(object,status){
          if(status){
            $('#pendingbt_table_container').block({
            ...
            $('#pendingbt_table_container').unblock();
          }
        });
        ...
        */
        ...
        pendingbt_table.on('kt-datatable--on-layout-updated',function(){
        ...
        $('#filterbtn').click(function(e){
            ...
            if($('#search-form').length){
                ...
                pendingbt_table.search(param, 'params');
            }
        });
    </script>
