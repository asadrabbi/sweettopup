...
@section('pageCss')
@section('title','Rejected Balance Transfer')
@endsection


@section('page-header','Rejected Balance Transfer')
...
@section('content')
    ...
    <section class="container">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body" id="rejectedbt_table_container">
                    <div class="kt-datatable" id="rejectedbt_table"></div>
                </div>
            </div>
        </div>
      </div>
...
@section('pageJs')
    ...
    <script type="text/javascript">
        "use strict";
        var rejectedbt_table;
        rejectedbt_table = $("#rejectedbt_table").KTDatatable({
            data: {
                type: "remote",
                source: {
                    read: {
                        url: "{{route('agent.rejectedbt')}}",
                        method: 'GET',
                        map: function(t) {
                            var e = t;
        ...
        rejectedbt_table.on('spinnerCallback',function(object,status){
          if(status){
            $('#rejectedbt_table_container').block({
            ...
            $('#rejectedbt_table_container').unblock();
          }
        });
        ...
        */
        ...
        rejectedbt_table.on('kt-datatable--on-layout-updated',function(){
        ...
        $('#filterbtn').click(function(e){
            ...
            if($('#search-form').length){
                ...
                rejectedbt_table.search(param, 'params');
            }
        });
    </script>
