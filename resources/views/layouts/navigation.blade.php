        ...
        <div class="sidenav-header-logo"><a href="{{url('/')}}" class="brand-small text-center"><strong class="text-primary">S</strong></a></div>
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li class=""><a href="balancetransfer.php"><i class="fa fa-mobile" aria-hidden="true"></i>Transfer Now</a></li>
              <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"><i class="fa fa-pie-chart" aria-hidden="true"></i>Reports</a>
                <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                  ...
                  <li class="{{Route::currentRouteName() == 'agent.pendingtopup' ? 'active' : '' }}"><a href="{{route('agent.pendingtopup')}}"><i class="fa fa-pie-chart" aria-hidden="true"></i>Pending BT Request</a></li>
                  <li class="{{Route::currentRouteName() == 'agent.pendingtopup' ? 'active' : '' }}"><a href="{{route('agent.pendingtopup')}}"><i class="fa fa-pie-chart" aria-hidden="true"></i>Rejected BT Request</a></li>
                  <li class="{{Route::currentRouteName() == 'agent.pendingtopup' ? 'active' : '' }}"><a href="{{route('agent.pendingtopup')}}"><i class="fa fa-pie-chart" aria-hidden="true"></i>Successful BT Request</a></li>
                </ul>
              </li>
