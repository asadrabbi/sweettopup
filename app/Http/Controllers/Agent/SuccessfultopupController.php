...
use Auth;
use Carbon\Carbon;
class SuccessfultopupController extends Controller
{
    ...
    function __construct() {
        ...
        $this->searchField = [
            ...
            'inetload_message' => [
                ...
                'placeholder' => 'Search by Transiction ID',
                'wrapper_class' =>'col-md-4 mt-3',
                'class' =>'form-control',
                'default' => '',
                'query'=>'LIKE',
    ...
    public function index(Request $request)
    {
        ...
        if($request->wantsJson()){
            ...
            $iNetLoadData = Inetloadfdr::where('inetload_from_user_id',$id)->where('inetload_to_user_id',$id)->whereInetloadStatus('2')->where('account_type','0')/*->whereBetween('inetload_time', array('1271012422000', '1586631622000'))*/->orderBy($sortField, $sortDirection)->with('agent');
        ...
        return view('agent.successfultopup')->with('searchField',$this->searchField);
    }else{
