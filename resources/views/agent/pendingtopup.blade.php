...
@section('page-header','Pending top Up')
...
@section('content')
    ...
    <section class="container">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body" id="pendingtopup_table_container">
                    <div class="kt-datatable" id="pendingtopup_table"></div>
                </div>
            </div>
        </div>
      </div>
...
@section('pageJs')
    ...
    <script type="text/javascript">
        "use strict";
        var pendingtopup_table;
        pendingtopup_table = $("#pendingtopup_table").KTDatatable({
            data: {
                type: "remote",
                source: {
                    read: {
                        url: "{{route('agent.pendingtopup')}}",
                        method: 'GET',
                        map: function(t) {
                            var e = t;
        ...
        pendingtopup_table.on('spinnerCallback',function(object,status){
          if(status){
            $('#pendingtopup_table_container').block({
            ...
            $('#pendingtopup_table_container').unblock();
          }
        });
        ...
        */
        ...
        pendingtopup_table.on('kt-datatable--on-layout-updated',function(){
        ...
        $('#filterbtn').click(function(e){
            ...
            if($('#search-form').length){
                ...
                pendingtopup_table.search(param, 'params');
            }
        });
    </script>
