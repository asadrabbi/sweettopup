...
use Auth;
use Carbon\Carbon;
class RejectedtopupController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->wantsJson()){
            ...
            $iNetLoadData = Inetloadfdr::where('inetload_from_user_id',$id)->where('inetload_to_user_id',$id)->whereInetloadStatus('3')->where('account_type','0')/*->whereBetween('inetload_time', array('1271012422000', '1586631622000'))*/->orderBy($sortField, $sortDirection)->with('agent');
        ...
        return view('agent.rejectedtopup')->with('searchField',$this->searchField);
    }else{
