...
@section('pageCss')
@section('title','Successful Balance Transfer')
@endsection


@section('page-header','Successful Balance Transfer')
...
@section('content')
    ...
    <section class="container">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body" id="successfulbt_table_container">
                    <div class="kt-datatable" id="successfulbt_table"></div>
                </div>
            </div>
        </div>
      </div>
...
@section('pageJs')
    ...
    <script type="text/javascript">
        "use strict";
        var successfulbt_table;
        successfulbt_table = $("#successfulbt_table").KTDatatable({
            data: {
                type: "remote",
                source: {
                    read: {
                        url: "{{route('agent.successfulbt')}}",
                        method: 'GET',
                        map: function(t) {
                            var e = t;
            ...
            columns: [
                ...
                },
                {
                    ...
                    title: 'Surcharge',
                    template: function(e){
                        return "৳ "+ parseFloat(e.surcharge).toFixed(2);
                    }
                },
                /*{
        ...
        successfulbt_table.on('spinnerCallback',function(object,status){
          if(status){
            $('#successfulbt_table_container').block({
            ...
            $('#successfulbt_table_container').unblock();
          }
        });
        ...
        */
        ...
        successfulbt_table.on('kt-datatable--on-layout-updated',function(){
        ...
        $('#filterbtn').click(function(e){
            ...
            if($('#search-form').length){
                ...
                successfulbt_table.search(param, 'params');
            }
        });
    </script>
