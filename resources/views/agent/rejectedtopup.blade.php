...
@section('pageCss')
@section('title','Rejected Top Up')
@endsection


@section('page-header','Rejected top Up')
...
@section('content')
    ...
    <section class="container">
      <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body" id="rejectedtopup_table_container">
                    <div class="kt-datatable" id="rejectedtopup_table"></div>
                </div>
            </div>
        </div>
      </div>
...
@section('pageJs')
    ...
    <script type="text/javascript">
        "use strict";
        var rejectedtopup_table;
        rejectedtopup_table = $("#rejectedtopup_table").KTDatatable({
            data: {
                type: "remote",
                source: {
                    read: {
                        url: "{{route('agent.rejectedtopup')}}",
                        method: 'GET',
                        map: function(t) {
                            var e = t;
        ...
        rejectedtopup_table.on('spinnerCallback',function(object,status){
          if(status){
            $('#rejectedtopup_table_container').block({
            ...
            $('#rejectedtopup_table_container').unblock();
          }
        });
        ...
        */
        ...
        rejectedtopup_table.on('kt-datatable--on-layout-updated',function(){
        ...
        $('#filterbtn').click(function(e){
            ...
            if($('#search-form').length){
                ...
                rejectedtopup_table.search(param, 'params');
            }
        });
    </script>
